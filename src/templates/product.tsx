                ...
                <div ref={imageWrapperRef} css={{
                    ...
                    <div css={{
                        ...
                        <div onMouseMove={(e) => {
                            ...
                            <img ref={imageRef} src={product.images[imageIndex]} loading="lazy" alt={`${product.name} main`} css={{
                                display: 'block',
                                width: '100%',
                        ...
                        <ul css={{
                            ...
                            {product.images.map((image, index) =>
                                <li key={index} onClick={() => setImageIndex(index)} css={{
                                    ...
                                    <div css={{
                                        ...
                                        <img src={image} loading="lazy" css={{
                                            display: 'block',
                                            maxWidth: '100%',
                                            position: 'absolute',
                                            top: '0',
                    ...
                    <div css={{
                        ...
                        <div css={{
                            ...
                            {product.prices.length > 1 &&
                                <select defaultValue={selectedPriceId} onChange={(event) => onSelectPrice(event.target.value)} css={{
                                    width: '100%',
                                    borderRadius: '40px',
                                    padding: '1.6rem 2rem',
                                    fontSize: '1.4rem',
                            ...
                            <button onClick={onAddToCartClick} type="button" css={{
                                margin: '1.5rem 0',
                                marginBottom: '1rem',
                                display: 'flex',
                                width: '100%',
