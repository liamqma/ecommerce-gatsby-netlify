      ...
      <div css={{
        ...
        <div css={{
          ...
          <button onClick={() => updateItem({ ...item, qty: item.qty - 1 })} css={{
            ...
            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="presentation" css={{
              width: '1rem',
              pointerEvents: 'none'
        ...
        <div css={{
          ...
          <button onClick={() => removeItem(item.id)} css={{
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" focusable="false" role="presentation" css={{
              height: '1.5rem',
              width: '1.5rem'
            }}>
        ...
        <div css={{
          ...
          <div css={{
            ...
            <div css={{
              ...
              <button onClick={checkout} disabled={loading} type="button" css={{
                width: '100%',
                fontSize: '1.5rem',
                letterSpacing: '0.1rem',
                justifyContent: 'center',
