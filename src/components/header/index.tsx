        ...
        <summary
          ...
          <span
            ...
            <svg
              ...
              focusable="false"
              role="presentation"
              css={[svgStyle, { 'details[open] &': svgInvisibleStyle }]}
              fill="none"
              viewBox="0 0 18 16">
              <path
            ...
            <svg
              ...
              focusable="false"
              role="presentation"
              css={[svgStyle, { 'details:not([open]) &': svgInvisibleStyle }]}
              fill="none"
              viewBox="0 0 18 17">
              <path
...
const Nav = ({ isSticky = false }: { isSticky?: boolean }) => (
  <nav
    css={{
      '@media screen and (min-width: 990px)': {
  ...
  return (
    <div
      ...
      <a
        ...
        <svg viewBox="0 0 1024 1024" fill="currentColor" height="2.1em" width="2.1em">
  ...
  return (
    <>
      <div
        css={{
          marginBottom: '15px',
          '@media screen and (min-width: 750px)': { marginBottom: '20px' },
        }}>
